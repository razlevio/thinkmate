	...
	return (
		<div className="prose mx-8 my-10 pt-16 text-foreground md:mx-auto">
			...
			<p>
				...
				website ('Site'), accessible from https://thinkmate.vercel.app, and any
				other services offered by us in connection with our site (any and all of
				the foregoing the 'Services').
			</p>
			<p>
				If you have additional questions or require more information about our
				Privacy Policy, do not hesitate to contact us at thinkmate77@gmail.com.
				This Privacy Policy applies only to our online activities and is valid
				for visitors to our website with regards to the information that they
				shared and/or collect in Thinkmate. This policy is not applicable to any
			...
			<p>
				...
				information. We use this information for personalization and any
